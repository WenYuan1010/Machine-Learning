...
class Drug(object):
    ...
    def __init__(self):#只要定义了一个Drug对象，就会执行该函数
    ...
    def page_reset(self,url):
        ...
        try:
            ...
            self.browser.find_element(By.LINK_TEXT,'关闭').click()
            time.sleep(2)
        except:
            element_existance = False

        keyword = '皖械注准'
        input_tag = self.browser.find_element(By.XPATH,'//*[@id="home"]/div[2]/div[7]/div/div[2]/input')
        input_tag.send_keys(keyword)
        element = self.browser.find_element(By.CLASS_NAME,'el-button.el-button--default')
        element.click()
        time.sleep(2)
        ...
        try:
            ...
            self.browser.find_element(By.LINK_TEXT,'跳过').click()
            time.sleep(2)
        except:
            element_existance = False
        ...
        for i in range(k, len(keywordlist)+1):
            ...
            print(keyword)
            input_keyword = self.browser.find_element(By.CLASS_NAME,
            ...
            input_page_tag = self.browser.find_element(By.XPATH,'//*[@id="home"]/div[3]/div[3]/div/span[3]/div/input')
    ...
    def search_in_webpage(self,browser,keyword):
        # 总页数
        pages=self.browser.find_element(By.CLASS_NAME,'el-pager').find_elements_by_class_name('number')[-1].text
        ...
        while signal:
            ...
            page = browser.find_element(By.CLASS_NAME,'el-pager').find_element(By.CLASS_NAME,'active').text
            print(page)
            xiangqing_list = self.browser.find_elements(By.CLASS_NAME,'el-button--primary')
            ...
            for i in range(1, len(xiangqing_list)+1):
                ...
                browser.find_element(By.XPATH,xpath_title).click()
                time.sleep(2)
                ...
                list_class = browser.find_elements(By.CLASS_NAME,'el-table_1_column_2.is-left ')
            ...
            if signal:
                ...
                if page == pages:
                    ...
                    self.browser.find_element(By.CLASS_NAME,'btn-next').click()
                    time.sleep(4)
